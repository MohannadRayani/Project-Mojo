...
public class UI_BuildButtonsHolder : MonoBehaviour
{
    ...
    private void CheckBuildButtonsHotkeys()
    {
        ...
        for (int i = 0; i < unlockedButtons.Count; i++)
        {
            ...
            {
                new SelectBuildButtonCommand(this, i).Execute();
                break;
            }
        }
        ...
        if (lastSelectedButton != null)
        {
            ...
            {
                lastSelectedButton.GetBuildCommand().Execute();
                previewTower = null;
            }

            if (Input.GetKeyDown(KeyCode.Q))
                new RotatePreviewCommand(previewTower, -90).Execute();
    ...
    public Transform GetPreviewTower() => previewTower;
