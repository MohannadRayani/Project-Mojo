...
public class UI_BuildButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler
{
    ...
    public TowerPreviewProxy towerPreview;
    ...
    private void CreateTowerPreview()
    {
        ...
        towerPreview = newPreview.AddComponent<TowerPreviewProxy>();
    ...
    public void SelectButton(bool select)
    {
        ...
        if (towerPreview.gameObject == null)
            return;
    ...
    public IUICommand GetBuildCommand()
    {
        return new BuildTowerCommand(this);
    }
