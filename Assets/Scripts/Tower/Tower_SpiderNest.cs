...
public class Tower_SpiderNest : Tower
{
    ...
    {
        base.Awake();
        attackStrategy = new SpiderNestAttackStrategy();
    }
    ...
    private sealed class SpiderNestAttackStrategy : ITowerAttackStrategy
    {
        public void Execute(Tower tower)
        {
            Tower_SpiderNest spiderNest = (Tower_SpiderNest)tower;
            spiderNest.lastTimeAttacked = Time.time;
            spiderNest.StartCoroutine(spiderNest.AttackCo());
        }
    }
